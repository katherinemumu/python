...
katherinemumu
Apr 29 2020
This program will turn a string into a list, and print out the frequences in a list
'''

#yeah or you coulda just used the count function
def strfreq(s):
    lst = s.split()
    d = dict()
    for i in lst:
...
def main():
    print(strfreq("hi hi hi hello how are you you"))
