...
for i in range(4,len(s)):
    if s[i].islower() and s[i-3].isupper() and s[i-2].isupper() and s[i-1].isupper() and s[i+2].isupper() and s[i+3].isupper() and s[i+1].isupper() and s[i-4].islower() and s[i+4].islower():
        answer += s[i]
